...
CURRENT_DIR="${ROOT_DIR}/schema/audittrail/contracts"
BASELINE_DIR="${ROOT_DIR}/schema/audittrail/baseline"
...
if not current_files:
    raise SystemExit("No Audit Trail contract files found.")
...
print("Audit Trail contract governance check passed.")
PY
