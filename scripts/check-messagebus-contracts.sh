...
CURRENT_DIR="${ROOT_DIR}/schema/messagebus/contracts"
BASELINE_DIR="${ROOT_DIR}/schema/messagebus/baseline"
...
if not current_files:
    raise SystemExit("No Message Bus contract files found.")
...
print("Message Bus contract governance check passed.")
PY
