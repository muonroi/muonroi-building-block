...
Plans:
- [ ] 12-01-PLAN.md — CssRuleSet: collect author rules once, split grouped selectors, specificity + source order + declarations
...
| 12. Owned CSS Cascade (B1) | 0/4 | Planned (B1.1, 4 plans) | - |
