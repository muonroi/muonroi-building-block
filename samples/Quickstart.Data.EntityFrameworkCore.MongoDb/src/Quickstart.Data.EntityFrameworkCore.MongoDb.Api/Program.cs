using Quickstart.Data.EntityFrameworkCore.MongoDb.Api;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Quickstart.Data.EntityFrameworkCore.MongoDb API",
        Version = "v1",
        Description = "Demonstrates MongoDb capabilities."
    });
});
...
app.MapGet("/health", () => Results.Ok(new { status = "Healthy", dbType = "MongoDb" }));
