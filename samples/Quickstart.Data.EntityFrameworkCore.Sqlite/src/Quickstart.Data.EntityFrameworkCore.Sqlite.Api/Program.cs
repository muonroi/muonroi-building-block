using Quickstart.Data.EntityFrameworkCore.Sqlite.Api;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Quickstart.Data.EntityFrameworkCore.Sqlite API",
        Version = "v1",
        Description = "Demonstrates Sqlite capabilities."
    });
});
...
app.MapGet("/health", () => Results.Ok(new { status = "Healthy", dbType = "Sqlite" }));
