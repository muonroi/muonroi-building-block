using Quickstart.Data.EntityFrameworkCore.PostgreSQL.Api;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Quickstart.Data.EntityFrameworkCore.PostgreSQL API",
        Version = "v1",
        Description = "Demonstrates PostgreSQL capabilities."
    });
});
...
app.MapGet("/health", () => Results.Ok(new { status = "Healthy", dbType = "PostgreSQL" }));
