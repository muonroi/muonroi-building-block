...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Quickstart.Data.EntityFrameworkCore.MySql API",
        Version = "v1",
        Description = "Demonstrates MySql capabilities."
    });
});
...
app.MapGet("/health", () => Results.Ok(new { status = "Healthy", dbType = "MySql" }));
