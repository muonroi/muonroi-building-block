...
public interface IInterceptedLogWriter
{
    ...
    void Write(string categoryName, LogLevel level, ILogger logger, string messageTemplate, params object?[] properties);
    ...
    /// <param name="messageTemplate">The message template.</param>
    /// <param name="properties">The resolved property values.</param>
    void Write(string categoryName, LogLevel level, ILogger logger, Exception exception, string messageTemplate, params object?[] properties);
}
