...
/// <summary>
/// AOT-safe alternative to AddMultiSiteProfiles — delegates to SiteProfileManifestRunner.
/// </summary>
...
{{
    public static IServiceCollection AddGeneratedSiteProfiles(
        ...
        => SiteProfileManifestRunner.Register(
            SiteProfileManifest.CreateAll(), services, configuration, siteCodeAccessor, logFactory);
}}
";
