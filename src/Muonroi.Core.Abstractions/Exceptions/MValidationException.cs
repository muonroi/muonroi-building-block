...
public sealed class MValidationException(IEnumerable<MValidationError> errors, string? message = null) : MException("VALIDATION_FAILED", message ?? "One or more validation errors occurred.", MExceptionCategory.Validation, 400)
{
    /// <summary>
    /// Gets the list of validation errors.
    /// </summary>
    public IReadOnlyList<MValidationError> Errors { get; } = errors.ToList().AsReadOnly();
