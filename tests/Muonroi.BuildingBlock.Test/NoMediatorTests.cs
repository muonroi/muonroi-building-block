...
public class NoMediatorTests
{
    ...
    public async Task CreateStream_Generic_Null_Returns_Empty()
    {
        NoMediator mediator = new();
        List<int> result = [];
        await foreach (int i in mediator.CreateStream<int>(null!))
            result.Add(i);
        Assert.Empty(result);
    }
    ...
    public async Task CreateStream_Object_Returns_Empty()
    {
        NoMediator mediator = new();
        List<object?> result = [];
        await foreach (object? o in mediator.CreateStream(new object()))
            result.Add(o);
        Assert.Empty(result);
    }
    ...
    public async Task CreateStream_Object_Null_Returns_Empty()
    {
        NoMediator mediator = new();
        List<object?> result = [];
        await foreach (object? o in mediator.CreateStream((object)null!))
            result.Add(o);
        Assert.Empty(result);
    }
    ...
    [Fact]
    public async Task Send_NonGeneric_Null_Completes()
    {
        NoMediator mediator = new();
