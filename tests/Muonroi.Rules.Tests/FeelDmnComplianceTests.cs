...
public class FeelDmnComplianceTests
{
    ...
    {
        object? result = FeelEvaluator.EvaluateValue("{x: 10, y: 20, sum: x + y}.sum", new Dictionary<string, object>());
    ...
    {
        object? result = FeelEvaluator.EvaluateValue("{add: function(x, y) x + y, result: add(2, 3)}.result", new Dictionary<string, object>());
    ...
    {
        object? result = FeelEvaluator.EvaluateValue("{base: 10, addBase: function(x) x + base, result: addBase(5)}.result", new Dictionary<string, object>());
